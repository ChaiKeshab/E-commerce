...
import { Button, Input, UnorderedList } from '../components/index'
...
const Footer = ({
    ...
    return (
        <footer className={`${className} hidden mt-10 md:block mx-auto`}>
            ...
            <div className='bg-[#666666] flex items-center justify-evenly flex-wrap py-8 space-x-12'>
                ...
                <div className='flex w-2/5 flex-wrap h-14'>
                    ...
                    />
                    <Button
                        className='text-white bg-red-500 w-1/4 hover:text-black'
                        label='Submit' />
                </div>
